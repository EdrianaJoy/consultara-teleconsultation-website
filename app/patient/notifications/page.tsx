 ...
 * 
 * @module app/patient/notifications/page
 */
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Stay up to date with your appointments and messages.</p>
        </div>
        <Button
          variant="outline"
      ...
      {userNotifications.length === 0 ? (
        <div className="bg-card rounded-xl p-10 border border-border text-center">
          ...
          <p className="text-muted-foreground">We will let you know when something needs your attention.</p>
        </div>
      ) : (
